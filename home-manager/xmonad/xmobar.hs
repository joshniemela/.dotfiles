Config { 
   ...
   , commands = 
        ...
        -- weather monitor
        [ Run Weather "EKCH" [ "--template", "<skyCondition> | <fc=#4682B4><tempC></fc>°C | <fc=#4682B4><rh></fc>% | <fc=#4682B4><pressure></fc>hPa"
                             ] 3600
        ...
        , Run BatteryP ["/sys/class/power_supply/CMB1"]        [ "--template" , "Batt: <acstatus>"
                             ...
                             , "--" -- battery specific options
                                       ...
                                       , "-o"	, "<left>% (<timeleft>)"
                                       -- AC "on" status
                                       , "-O"	, "<fc=#dAA520>Charging (<timeleft>) </fc>"
                                       -- charged status
        ...
        , Run Date           "<fc=#656565> Week %V %F (%a) %T</fc>" "date" 10
